...
const Homepage3 = () => {
    return (
        <div className='flex flex-col w-full h-full '>
            ...
            <div className='flex h-full w-full p-4 justify-center items-start mt-20 mx-auto  ' >
                <div className='flex flex-col justify-center items-center '>
                    <div className='flex flex-col md:flex-row items-center w-full m-4 md:m-auto md:w-2/3 text-center shadow-lg shadow-black p-4'>
                        <h1 className='text-white text-5xl border-b-2 md:border-b-0 md:border-r-2 border-yellow-400 p-3 bebas-neue-regular   '>
                            Welcome to our <span className='text-yellow-400'>LightMind
                            </span> Journaling site.

                        </h1>
                        <p className='text-stone-500 p-3 text-lg '><span className='text-yellow-400 yusei-magic-regular'>LightMind</span> is an intelligent journal app designed to track your emotions, provide insightful mood graphs, and offer personalized tips for self-improvement. Powered by advanced <span className='text-yellow-400'>AI</span>, LightMind helps you understand your emotional patterns and take meaningful steps toward a happier, healthier you.</p>

                    </div>

                    <div className='flex md:mt-10  h-full w-full justify-center items-center m-auto'>
