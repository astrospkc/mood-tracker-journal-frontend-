...
const Page1 = () => {
    return (
        <div className=" bg-yellow-500 w-full flex flex-col md:flex-row text-2xl h-full">
            <div className='flex-1  bg-yellow-400 h-full w-full justify-center items-center m-auto'>
                ...
                <div className='relative h-full'>
                    ...
                    <div className='absolute top-[0%] md:top-[30%] left-[5%] md:left-[0%]'>
                        <div className='text-slate-900 chonburi-regular flex flex-col justify-center items-center gap-20 rounded-xl w-fit h-fit p-10 '>
                        ...
                        <div className='absolute top-[10%]'>
                            <div className='flex flex-row md:flex-col justify-center items-center'>
                                ...
                                <div className='w-full flex-row md:flex-col'>
                                    <Link to="/journals">
                                        <div className='flex flex-col  items-center gap-2 my-3 p-3  rounded-3xl hover:bg-yellow-100 hover:cursor-pointer'>
